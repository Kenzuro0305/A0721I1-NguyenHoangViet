...
<div id="wp-featured-post">
    ...
    <div class="container justify-content-between">
        ...
        <div class="box featured-post">
            <div class="box-head">
                <a href="/product" class="create" style="padding: 5px 10px;
                    background: #FF2C2B;
                    font-size: 20px;
                      color: white;
        ...
        <div class=" pt-20" style="width: 100%; ">
            ...
            <form action="/product?action=create" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="maBenhAn" id="maBenhAn" placeholder="Nhập mã bệnh án" value="${benhNhan.getMaBenhAn()}">
                    <span style="color: red;">${stringList[0]}</span>
                </div>
                <div class="mb-3">
                    <label for="maBenhNhan" class="form-label">Mã bệnh nhân</label>
                    <input type="text" class="form-control" name="maBenhNhan" id="maBenhNhan" placeholder="Nhập mã bệnh nhân" value="${benhNhan.getMaBenhNhan()}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="liDo" id="lyDo" placeholder="Nhập lý do" value="${benhNhan.getLyDo()}">
