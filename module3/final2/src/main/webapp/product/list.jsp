        ...
        <div class="container">
            <nav>
                <ul id="main-menu" class="d-flex">
                    ...
                    <li class="acc"><a style="color:#23282E;" href=""></a></li>
                </ul>
            </nav>
        </div>
    ...
    <div id="wp-featured-post">
        <div class="container justify-content-between">
            <div class="box featured-post">
                <div class="box-head">
                    <h3><a href="/product">Danh sach</a></h3>
                </div>
            </div>
            <div class="box featured-post">
                <div class="box-head">
            ...
            <div class="box featured-post">
                <div class="box-head">
                    <a href="/product?action=create" class="create" style="padding: 5px 10px;
                    background: #FF2C2B;
                    font-size: 20px;
                      color: white;
                    ...
                    <c:forEach items="${productList}" var="e">
                        <tr>
                            ...
                            <c:forEach items="${categoryList}" var="t">
                                <c:if test="${t.getId() == e.getCategoryId()}">
                                    ${t.getName()}
                                </c:if>
                            </c:forEach>
                            </td>
                            ...
                            <td>
                                <a class="btn btn-primary" href="/product?action=edit&id=${e.getId()}"
                                   style="margin-bottom:10px "><i class="fa-solid fa-pen-to-square"></i></a>
                                    <%--                            modal lien ket     --%>
                                <button type="button"
                                        onclick="getNameId('${e.getId()}','${e.getName()}')"
        ...
        <div class="modal-content">
            ...
            <form action="/product" method="get">
                <div class="modal-body">
                    ...
                    <span>Bạn có muốn xoá thông tin product </span><span class="deleteName"></span>
