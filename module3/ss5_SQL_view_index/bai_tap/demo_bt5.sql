...
insert into products value(1,"code1","ss1",16,5,"Chống nước","New");
insert into products values
(2,"code2","ss2",14,2,"Chụp đêm","Used"),
(3,"code3","ss3",14,2,"Chụp đêm","Used");
set SQL_SAFE_UPDATES = 0;
update products set productName ="ss" where Id =1;
...
create index idx_products on products(productPrice);
...
END $$
DELIMITER ;
call add_new_product(4,"code4","Iphone 13",200,10,"pro max","New");
call add_new_product(5,"code5","Iphone 12",150,5,"khoa id","Used");
select * from products;
