        ...
        <div class="container">
            <nav>
                <ul id="main-menu" class="d-flex">
                    ...
                    <li class="acc"><a style="color:#23282E;" href="">Thư Viện</a></li>
                </ul>
            </nav>
        </div>
    ...
    <div id="wp-featured-post">
        <div class="container justify-content-between">
            <div class="box featured-post">
                <div class="box-head">
                    <h3><a href="/thuvien">Danh sach sách</a></h3>
                </div>
            </div>
            <div class="box featured-post">
                <div class="box-head">
                    <form action="/thuvien" method="get">
                        <div class="input-group">
                            <%--                            thêm mới trường search--%>
                            <input type="text" name="action" value="search" hidden>
                            <input type="search" name="search" class="form-control rounded" placeholder="Search by name"
                                   aria-label="Search" aria-describedby="search-addon"/>
                            <button type="submit" class="btn btn-outline-primary" style="color:#000;background: red">
                                search
                            </button>
                        </div>
                    </form>
            ...
            <div class="box featured-post">
                <div class="box-head">
                    <a href="/thuvien?action=create" class="create" style="padding: 5px 10px;
                    background: #FF2C2B;
                    font-size: 20px;
                      color: white;
        ...
        <div class="container">
            <div class=" pt-20" style="width: 100%; ">
                <table class="table table-striped table-bordered" style="width: 100%;" id="tableEmployee">
                    ...
                    <tbody>
                    <c:forEach items="${thuVienList}" var="e">
                        <tr>
                            <td>${e.getMaSach()}</td>
                            <td>${e.getTenSach()}</td>
                            <td>${e.getSoLuong()}</td>
                            <td>${e.getMoTa()}</td>
                            <td>
                                <a class="btn btn-primary" href="create.jsp" role="button">Mượn</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
        ...
        <div class="modal-content">
            ...
            <form action="/thuvien" method="get">
                <div class="modal-body">
                    ...
                    <span>Bạn có muốn xoá thông tin  </span><span class="deleteName"></span>
