...
public class ProductManager {
    ...
    static {
        productArrayList.add(new Product(id++, "Macbook Air", 3500));
        productArrayList.add(new Product(id++, "Macbook Pro", 4200));
        productArrayList.add(new Product(id, "Apple Watch", 350));
    }
